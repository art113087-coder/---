    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
        ...
        config: {
          ...
          systemInstruction: `You are a professional fashion assistant for "Zhumagul" in Shymkent. Respond ONLY in ${lang === 'kk' ? 'Kazakh' : lang === 'ky' ? 'Kyrgyz' : 'Russian'}. Shop address: ${SHOP_ADDRESS}.`
        }
      });
